    ...
    <section class="flex h-screen">
        ...
        <div class="w-7/12 flex items-center justify-center bg-white">
            <div class="bg-[#08005E] text-white rounded-2xl p-10 w-[346px] flex flex-col justify-between">
                ...
                <form method="post" action="{routePath('login-validate')}" class="space-y-4 mb-12">
                    <div class="flex flex-col">
                        <label class="text-sm font-medium mb-1">{lang key='clientareaemail'}</label>
                        <input type="email" name="username" placeholder="name@example.com" class="h-10 px-3 rounded-md bg-[#1D1484] border border-white text-white text-sm font-medium placeholder:text-[#8E7DF8] focus:outline-none focus:border-[#8E7DF8] focus:shadow-[0_0_10px_rgba(142,125,248,0.6)] hover:shadow-[0_0_8px_rgba(142,125,248,0.8)] transition-all duration-300" />
                    </div>
                    <div class="flex flex-col">
                        <div class="flex justify-between mb-1">
                            <label class="text-sm font-medium">{lang key='clientareapassword'}</label>
                        ...
                        <input type="password" name="password" placeholder="Password" class="h-10 px-3 rounded-md bg-[#1D1484] border border-white text-white text-sm font-medium placeholder:text-[#8E7DF8] focus:outline-none focus:border-[#8E7DF8] focus:shadow-[0_0_10px_rgba(142,125,248,0.6)] hover:shadow-[0_0_8px_rgba(142,125,248,0.8)] transition-all duration-300" />
                    </div>
                    ...
                    <button type="submit" class="w-full bg-[#F7B548] text-black font-bold py-2 px-4 rounded-md hover:bg-[#ffc107] transition-colors duration-300">
                ...
                <div class="text-center space-y-3">
                    ...
                    <p class="text-sm font-normal">
                        {lang key='userLogin.notRegistered'} <a href="{$WEB_ROOT}/register.php" class="font-semibold text-[#C0BFF6] underline hover:text-[#8E7DF8] transition-colors duration-200">{lang key='userLogin.createAccount'}</a>
                    </p>
                </div>
            </div>
        </div>
